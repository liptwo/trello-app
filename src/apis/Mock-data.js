  ...
  board: {
    ...
    columns: [
        ...
        cards: [
          {
            ...
            cover: 'https://trello.com/1/cards/6825810c5818ae3042236eb0/attachments/6825810d5818ae3042236faf/download/sergey-shmidt-koy6FlCCy5s-unsplash.jpg',
      ...
      },
      {
        ...
        // Fix bug truong hop card ko có phan tu
        cardOrderIds: ['card-id-1444-placeholder-card-not-empty'],
        cards: [
          { _id: 'card-id-1444-placeholder-card-not-empty',
            boardId: 'board-id-01',
